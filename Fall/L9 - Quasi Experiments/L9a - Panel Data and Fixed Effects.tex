...
\begin{itemize}
	...
	here: the between regression attributes part of $\alpha_i$ to $\bar x_i$, so $\hat\sigma^2_\alpha$ and hence $\hat\theta$
	are too small, and the leftover $\alpha_i$ inflates RE's residual variance.) Software will either report nonsense or refuse.
