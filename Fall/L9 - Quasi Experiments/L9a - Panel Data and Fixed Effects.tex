...
\begin{itemize}
	...
	\medskip
	\item Shrink toward the mean in proportion to noise (empirical Bayes; the RE model again):
	\begin{align*}
		\hat\alpha_i^{EB} = \frac{\sigma^2_\alpha}{\sigma^2_\alpha + \sigma^2_\varepsilon/T_i}\,\hat\alpha_i .
	\end{align*}
