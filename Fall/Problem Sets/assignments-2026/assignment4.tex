...
(Session 1's indicator trick): $\E[y \mid D=1] - \E[y \mid D=0]$. Substitute the outcome
...
the 2SLS estimate, which of the assumptions in (c) failed (think about both), and did the check in (d) catch it?
