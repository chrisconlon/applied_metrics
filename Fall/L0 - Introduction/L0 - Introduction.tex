...
\end{itemize}
\medskip
Rusty on linear algebra? Work through the self-study
\href{https://github.com/chrisconlon/applied_metrics/blob/master/Fall/L1\%20-\%20Probability/linear_algebra_handout.pdf}{\alert{Linear Algebra Review}}
(also linked on the course page) before Session 2. Khan Academy's
\emph{vectors and spaces} and \emph{matrix transformations} units cover anything the handout skips.
\end{frame}
