...
\item Cunningham, \href{https://mixtape.scunning.com}{\emph{Causal Inference: The Mixtape}} (free online; chapter numbers below follow the second edition, ``The Remix''):
...
Your grade will be based on seven short individual assignments (40\% in total, equally weighted),
two quizzes (10\% each), and a final research project (40\%). Assignments are short and frequent
by design --- two problems, due every other week after the first month --- so that the material
from each lecture gets used while it is fresh.
...
1  & 9/3 & H 2,6; G App.~A--B & Probability and Statistics (by simulation); research workflow \\
 &  &  & \\
\hline
2  & 9/10  &  H 3--4; G 3 &  Linear Regression: mechanics, interpretation, FWL, omitted variables  \\
 &  &  & \\
\hline
