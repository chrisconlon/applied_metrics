...
\begin{itemize}
	...
	where controlling for something \emph{creates} association.
\end{itemize}
\end{frame}
...
Collider (caused by two paths' worth of causes) & \alert{Never} & opens a closed path \\
Descendant of $Y$ & \alert{Never} & conditioning on the outcome \\
Instrument (affects $D$ only) & No & \alert{amplifies} remaining bias \\
\hline
\end{tabular}
\end{center}
\smallskip
\begin{itemize}
	...
	\emph{pre-experiment} outcomes (last month's spend) is pure precision gain ---
