...
% SUPERSEDED (Fall 2026): this deck was merged into "L4- Variance of OLS.tex"
% (which picked up the Newey-West/HAC frame, the "What about beta?" transition,
% and a compressed WLS/GLS frame). Kept for reference; do not present.
