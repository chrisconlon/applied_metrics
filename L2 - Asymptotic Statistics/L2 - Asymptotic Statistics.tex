...
\begin{align*}
\Pr\{|X-\mu| \geq k\}=\Pr\left\{(X-\mu)^2 \geq k^2\right\}\\ 
\end{align*}
...
\begin{align*}
\Var (S_n) &= \Var\left(\frac{1}{N}(X_1 + X_2 + \cdots X_n) \right)= \frac{1}{n^2} \Var \left(X_1 + X_2 + \cdots X_n \right) \\
&= \frac{1}{n}\sum_{i=1}^n \Var(X_i)= \frac{n \sigma^2}{n^2} = \frac{\sigma^2}{n} 
\end{align*}
