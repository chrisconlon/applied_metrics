...
\end{frame}
%
%\begin{frame}{Binary Choice with Covariates}
%%We probably are interested in more complicated cases where $p$ is not the same for all observations but rather $p(X)$ depends on some covariates. 
