...
treatment effects, maximum likelihood, binary choice models, and an
...
\item Wager, \href{https://web.stanford.edu/~swager/causal_inf_book.pdf}{\emph{Causal Inference: A Statistical Learning Approach}} (free draft):
	where causal inference meets machine learning; we draw on it near the end of the course.
...
Readings: H = Hansen, G = Goff, CM = Cunningham (Mixtape), W = Wager. Read before class.
\begin{center}
...
\hline
 ...
 &  &  &   \\
\hline
13  & 12/3  & H 22--23; W 3--4 & Count Data, Model Selection, and Machine Learning (prediction vs.\ causation)  \\
 &  &  & \textbf{\textit{In-class quiz}}  \\
