...
\begin{itemize}
	...
	\underbrace{SST}_{\text{total}} = \underbrace{SSR}_{\text{explained}} + \underbrace{SSE}_{\text{residual}}
	\]
	...
	R^{2} = \frac{SSR}{SST}
	= 1 -  \frac{{\bf e}'{\bf e}}{\sum_i \left(y_i - \bar{y}\right)^2}
\]
...
\begin{itemize}
	...
	require normality of the error terms. (Good operator practice: expand the square and apply
...
\bigskip
\begin{itemize}
	\item Open \texttt{inclass\_session2.Rmd} (in the \texttt{L3 - Linear Regression} folder of the course repo).
