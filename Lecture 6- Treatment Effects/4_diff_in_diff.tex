...
\end{itemize}
\item Relied purely on \alert{cross sectional} variation to construct a control group.
\item Often (in this course at least) we have access to \alert{panel data}.
\begin{itemize}
